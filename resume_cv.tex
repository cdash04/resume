...
\name{Christophe D.}{Ashworth}
% \address{}
% \mobile{999 999-9999}

\email{contact@cda.sh}
\github{cdash04}
...
\position{Software Developper} % Your expertise/fields

\makecvfooter{\today}{Christophe D. Ashworth~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
